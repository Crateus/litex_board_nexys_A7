...
from litex_boards.platforms import digilent_nexysA7
...
class BaseSoC(SoCCore):
    def __init__(self, variant="a7-100", toolchain="vivado", sys_clk_freq=int(100e6),
        ...
        **kwargs):
        platform = digilent_nexysA7.Platform(variant=variant, toolchain=toolchain)
...
#        with_dram = (kwargs.get("integrated_main_ram_size", 0) == 0)
        ...
        # SoCCore ----------------------------------_-----------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on Nexys A7", **kwargs)
        ...
        # GPIOs ------------------------------------------------------------------------------------
        if with_pmod_gpio:
            platform.add_extension(digilent_nexysA7.raw_pmod_io("pmoda"))
...
def main():
    ...
    parser = LiteXSoCArgumentParser(description="LiteX SoC on Nexys A7")
    ...
    target_group.add_argument("--variant",             default="a7-100",                  help="Board variant (a7-50 or a7-100).")
